            ...
            <MDBRow>
                ...
                <MDBCol col='4' md='6'>
                    ...
                    <div className="d-flex justify-content-between mx-4 mb-4">
                        ...
                        <a href="/Lost" className='text-primary'>Forgot password?</a>
                    </div>
                    ...
                    <MDBBtn href="/NewAccount" className="mb-4 w-100" size="lg" style={{ backgroundColor: '#5975ee' }}>
                        <MDBIcon fab icon="plus" className="mx-2" />
                        Create New Account
                    </MDBBtn>
                </MDBCol>
