...
import AccessoireProducts from '../../AccessoireData.js';
import './style.css'

const AccessoirePage = () => {
    const [store, setStore] = useState("Store");
    const [arr, setArr] = useState(AccessoireProducts);
    const [currentPage, setCurrentPage] = useState(1);
    const productsPerPage = 12;

    const handleClick = (buttonCategory) => {
        const newArr = AccessoireProducts.filter((item) => item.ProductType === buttonCategory);
        setArr(newArr);
